	...
	private static class SearchNode implements Comparable<SearchNode> {
		...
		public int compareTo(SearchNode o) {
			if (hardness==0)
				...
				return (this.board.getCombinedManhattanHammingDistance()+ this.moves) - (o.board.getCombinedManhattanHammingDistance() + o.moves);

		}
	}

	public AStarSolver(Board initial,int hardnessd) {
		try {
			hardness=hardnessd;
